    ...
    <>
      ...
      <div
        className={`max-w-[112rem] mt-18 mx-auto px-4 ${
          isMobile || isTablet ? "relative h-screen" : animation.sectionPassed ? "hidden" : "fixed inset-0"
        } bg-white z-10 overflow-hidden flex items-center justify-center transition-all duration-500`}
        style={{
          // For desktop: hide when section is passed, otherwise fixed
          display: !isMobile && !isTablet && animation.sectionPassed ? 'none' : 'flex'
        }}
      >
        {(isMobile || isTablet) ? (
      ...
      {/* Content after about section - will automatically show since hero is hidden */}
