      ...
      <div className="relative max-w-[112rem] mx-auto px-4 py-20 min-h-[150vh] flex flex-col justify-between z-10">
        ...
        <div className="sticky top-0 pt-32 pb-16">
          <div className="flex justify-between items-start">
            <div>
              <p className="neue text-xl md:text-2xl font-[500] text-[#f5d6c7]">06. STORE</p>
          ...
          >
            <div className="bg-white/5 border border-white/10 p-8 md:p-12 rounded-xl backdrop-blur-sm">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="inline-block border-2 border-[#ae1794a] px-12 py-4 rounded-full neue font-[500] text-xl transition-colors duration-300"
              >
                SHOP NOW
              </motion.a>
