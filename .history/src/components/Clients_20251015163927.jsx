...
const Clients = () => {
  ...
  const clients = [
    ...
    { name: "Render", subs: 0.531, logo: "https://yt3.googleusercontent.com/3qYIq8gC28UuT2q7kfYMhkTSosIymrY0WmiiMmCY8ktEikfJBYCbU0KC9_OBRVRmiKc521FqoQ=s160-c-k-c0x00ffffff-no-rj" },
        ...
        {clients.length > 8 && (
          <div className="flex justify-center mt-8">
            <button
              ...
              className="neue bg-[#e1794a] text-white px-8 py-3 font-[500] text-[4vw] sm:text-[2.5vw] md:text-[1.1vw] uppercase tracking-wide hover:scale-105 transition rounded-xl transition-colors duration-200"
            >
