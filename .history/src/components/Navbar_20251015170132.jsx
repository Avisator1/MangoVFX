...
const Navbar = () => {
  ...
  return (
    <div className="w-full neue">
      {/* Main Navbar - Simple and visible */}
      {!menuOpen && (
        <nav className="fixed backdrop-blur-md bg-black/80 border border-white/20 transition-all duration-500 top-2 left-1/2 -translate-x-1/2 w-[calc(100%-3rem)] md:w-[calc(100%-4rem)] max-w-[112rem] rounded-lg px-8 z-[999999]">
          {/* Header */}
