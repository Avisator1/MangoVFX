      ...
      <div className="relative max-w-[112rem] mx-auto px-4 py-32 md:py-48 min-h-[150vh] flex flex-col justify-between z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32">
          ...
          <motion.div 
            ...
            viewport={{ once: true, margin: "-100px" }}
          >
            <div className="bg-white/5 border border-white/10 p-8 md:p-12 rounded-f backdrop-blur-sm">
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className="inline-block border-2 border-white px-12 py-4 rounded-full neue font-[500] text-xl transition-colors duration-300 cursor-not-allowed opacity-70"
              >
                COMING SOON
              </motion.div>
