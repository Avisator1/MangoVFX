...
=======
    { value: 750, label: 'LIKES', type: 'likes', format: (v) => formatLabel(v, 'likes') },
    { value: 33, label: 'VIEWS', type: 'views', format: (v) => formatLabel(v, 'views') },
    { value: 400, label: 'THUMBNAILS', type: 'orders', format: (v) => formatLabel(v, 'orders') },
>>>>>>> 9b16e104ff1f7f28a15f306edf69bc143b335c0c
  ];
      ...
      <div className="relative max-w-[112rem] mx-auto px-4 py-32 md:py-48 min-h-[100vh] z-10">
        ...
        <div className="sticky top-0 pt-32 pb-16">
          <div className="flex justify-between items-start">
            <div>
              <p className="neue text-xl md:text-2xl font-[500]">03. STATISTICS</p>
        ...
        <div className="md:flex-row flex flex-col  justify-between gap-8 md:gap-16 mt-16">
          {stats.map((stat, i) => (
            ...
            >
              <p className="neue text-[8vw] md:text-[5vw] font-[500] text-gray-200/80 leading-none mb-2">
                0{i+1}
              </p>
