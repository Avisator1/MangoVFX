        ...
        {clients.length > 8 && (
          <div className="flex justify-center mt-8">
            <button
              ...
              className="neue bg-white text-black px-8 py-3 font-[500] text-[4vw] sm:text-[2.5vw] md:text-[1.1vw] uppercase tracking-wide hover:bg-gray-200 rounded-xl transition-colors duration-200"
            >
