    ...
    <div className="w-full neue">
      ...
      {!menuOpen && (
        <>
          ...
          <nav className="md:hidden fixed backdrop-blur-md bg-white/20 border border-white/10 transition-all duration-500 top-2 left-1/2 -translate-x-1/2 w-[calc(100%-3rem)] rounded-lg px-6 z-[999999]">
