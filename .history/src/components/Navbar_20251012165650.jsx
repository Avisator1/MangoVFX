...
const Navbar = () => {
  ...
  return (
    <div className="w-full neue">
      ...
      {!menuOpen && (
        <nav className="fixed mix-blend-difference backdrop-blur-md transition-all duration-500 top-2 left-1/2 -translate-x-1/2 w-[calc(100%-3rem)] md:w-[calc(100%-4rem)] max-w-[112rem] rounded-lg px- z-[999999]">
          {/* Header */}
