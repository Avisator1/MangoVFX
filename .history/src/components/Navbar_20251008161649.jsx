                ...
                {menuItems.map((item, index) => (
                  <div key={index} className="border-b border-gray-800 last:border-b-0">
                    <a
                      ...
                      className="block text-4xl md:text-5xl neue lg:text-6xl xl:text-7xl font-[400] py-4 md:py-6 text-white hover:text-gray-300 transition-all duration-300 text-left font-sans hover:pl-4"
                      onClick={() => setMenuOpen(false)}
                    >
                      {item}
                    </a>
