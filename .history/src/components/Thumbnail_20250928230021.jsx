      ...
      <div className="max-w-[112rem] mx-auto pt-20 md:pt-32 pb-16 px-4 mt-20">
        <div className="flex justify-between items-end mb-8">
          <div className="w-full">
            ...
            <ScreenFitText>THUMBNAIL GALLERY</ScreenFitText>
          </div>
...
const ScreenFitText = ({ children }) => {
  ...
  return (
    ...
    >
      <span
        ref={textRef}
        className="whitespace-nowrap text-center font-bold uppercase neue"
        style={{
          background: "linear-gradient(to bottom, #e1794a 50%, black 50%)",
