...
>
  ...
  />
                ...
                <h1
                  className="absolute neue font-[500] text-[#e1794a] text-white leading-none tracking-tight text-[min(11vw,300px)]"
                  style={{
                    top: "-30%",
                    right: "35%",
                ...
                <h2
                  className="absolute neue font-[500] bg-[#e1794a] text-white  leading-none tracking-tight text-[min(11vw,300px)]"
                  style={{
                    bottom: "-30%",
                    left: "35%",
                    transform: "translateY(50%)",
