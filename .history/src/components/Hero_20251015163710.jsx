...
>
  ...
  />
      ...
      {/* Text Reveal Section */}
      <div
        className="text-reveal-section neue uppercase bg-white"
        ref={textSectionRef}
        style={{
        ...
        <div className="w-full min-h-screen bg-black flex justify-between items-center px-4 md:px-8">
          <div className="max-w-[112rem] mx-auto w-full flex flex-col md:flex-row">
            ...
            <div className="self-end mb-[0.75rem] mt-8 md:mt-0">
              <a className="bg-[#e1794a] text-black px-6 py-4 md:px-4 md:py-3 neue rounded-lg font-[500] cursor-pointer">
                CONTACT ME
              </a>
            </div>
          </div>
