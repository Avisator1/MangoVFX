        ...
        {clients.length > 8 && (
          <div className="flex justify-center mt-8">
            <button
              ...
              className="neue bg-[#e1794a] text-white px-8 py-3 font-[500] text-[4vw] sm:text-[2.5vw] md:text-[1.1vw] uppercase tracking-wide hover:scale rounded-xl transition-colors duration-200"
            >
