      ...
      <div className="relative max-w-[112rem] mx-auto px-4 py-32 md:py-48 min-h-[100vh] z-10">
        ...
        <div className="md:flex-row flex flex-col  justify-between gap-8 md:gap-16 mt-16">
          {stats.map((stat, i) => (
            ...
            >
              <p className="neue text-[8vw] md:text-[5vw] font-[500] text-[#e1794a] leading-none mb-2">
                0{i+1}
              </p>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="inline-block border-2 border-[#e1794a] px-12 py-4 hover:bg-[#e1794a] rounded-full neue font-[500] text-xl transition-colors duration-300"
          >
