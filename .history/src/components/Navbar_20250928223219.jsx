...
const Navbar = () => {
  ...
  return (
    <div className="w-full">
      <nav className="fixed mix-blend-difference neue backdrop-blur-md transition-transform duration-500 top-6 left-1/2 -translate-x-1/2 w-[calc(100%-3rem)] md:w-[calc(100%-4rem)] max-w-[112rem] bg-white/3 rounded-md px-8 z-[999999]">
