                ...
                {menuItems.map((item, index) => (
                  <div key={index} className="border-b border-gray-100/50 last:border-b-0">
                    <a
                      ...
                      className="block text-4xl md:text-5xl lg:text-6xl xl:text-5xl font-[400] py-4 md:py-6 text-white hover:text-gray-300 transition-all duration-300 text-left hover:pl-4"
                      onClick={() => setMenuOpen(false)}
                    >
                      {item}
                    </a>
